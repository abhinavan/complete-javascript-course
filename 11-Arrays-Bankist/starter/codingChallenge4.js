...
//const sarahDogUsingFind = dogs.find(dog => dog.owners.includes('Sarah')); // another way to find dog with owner sarah
sarahDog.map(d =>
...
console.log(`Owners eat too less ${ownersEatTooLittle}`);
...
if (dogs.find(dog => dog.curFood == dog.recommendedFood)) {
  console.log(true);
} else {
  console.log(false);
}
...
// Task 6
const callbackPredicate = dog =>
  dog.curFood > dog.recommendedFood * 0.9 &&
  dog.curFood < dog.recommendedFood * 1.1;
const dogsEatingOkayAmount = dogs.some(callbackPredicate);
